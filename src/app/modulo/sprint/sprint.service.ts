...
export class SprintService {
  ...
  public deleteSolicitacaoDaSprint(sprintId: number, solicitacaoId: number) {
    return this.http.delete(`${env.API_TICKET}${this.pathBase}/${sprintId}/solicitacao/${solicitacaoId}`).pipe(take(1));
  }
